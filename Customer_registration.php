...
<div class="bg centered" style="width: 75%; height: auto;">
        <br><h1>Registration Form</h1><br><hr><br>
        <h3>
        <form method="post">
        Name: <input type="text" name="name"><br><br>
        Contact Number: <input type="text" name="contact_no"><br><br>
    ...
    </h3><br><hr><input type="submit" class="c" name="register" value="Register"><br><br>
</form>
    </div>
</body>
</html>